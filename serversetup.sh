...
# serversetup.sh always writes an override so docker compose uses the current host
# uid/gid and any required SELinux relabeling options.
banner "Writing docker-compose.override.yml"

cat > docker-compose.override.yml <<OVERRIDE_EOF
# Generated by serversetup.sh — customises paths and bind address.
